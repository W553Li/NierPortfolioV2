...
export default function Projects() {
  ...
  const panelContent = {
    "ASTunnel":       ['<img src="/NierPortfolioV2/images/ASTunnel.png" alt="ASTunnel Preview" style="width: 100%; max-width: 600px; margin: 1rem 0;"/>',
    ...
    "BudgetTracker":  ['<img src="/NierPortfolioV2/images/BudgetTracker.png" alt="Budget Tracker Preview" style="width: 100%; max-width: 600px; margin: 1rem 0;"/>',
    ...
    "ImageSearcher":  ['<img src="/NierPortfolioV2/images/ImageSearch.png" alt="Image Seacher Preview" style="width: 100%; max-width: 600px; margin: 1rem 0;"/>',
    ...
    "ToDoList":       ['<img src="/NierPortfolioV2/images/Newtodolist.png" alt="ToDoList Preview" style="width: 100%; max-width: 600px; margin: 1rem 0;"/>',
    ...
    "Snake":          ['<img src="/NierPortfolioV2/images/snake.png" alt="ToDoList Preview" style="width: 100%; max-width: 600px; margin: 1rem 0;"/>',
    ...
    "Candlelight":    ['<img src="/NierPortfolioV2/images/candlelight.png" alt="ToDoList Preview" style="width: 100%; max-width: 600px; margin: 1rem 0;"/>',
