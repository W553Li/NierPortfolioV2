...
export default function Projects() {
  ...
  const panelContent = {
    "ASTunnel":       ['<img src="/w553li.github.io/images/ASTunnel.png" alt="ASTunnel Preview" style="width: 100%; max-width: 600px; margin: 1rem 0;"/>',
    ...
    "BudgetTracker":  ['<img src="/w553li.github.io/images/BudgetTracker.png" alt="Budget Tracker Preview" style="width: 100%; max-width: 600px; margin: 1rem 0;"/>',
    ...
    "ImageSearcher":  ['<img src="/w553li.github.io/images/ImageSearch.png" alt="Image Seacher Preview" style="width: 100%; max-width: 600px; margin: 1rem 0;"/>',
    ...
    "ToDoList":       ['<img src="/w553li.github.io/images/Newtodolist.png" alt="ToDoList Preview" style="width: 100%; max-width: 600px; margin: 1rem 0;"/>',
    ...
    "Snake":          ['<img src="/w553li.github.io/images/snake.png" alt="ToDoList Preview" style="width: 100%; max-width: 600px; margin: 1rem 0;"/>',
    ...
    "Candlelight":    ['<img src="/w553li.github.io/images/candlelight.png" alt="ToDoList Preview" style="width: 100%; max-width: 600px; margin: 1rem 0;"/>',
